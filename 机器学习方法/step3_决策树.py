...
if __name__ == '__main__':
    ...
    for select_SNR in SNR_list:
        ...
        X_train, X_valid, y_train, y_valid = train_test_split(X_data, Y_df['Modulation'], test_size=0.22,
                                                              random_state=42)

        XY_df = X_Y.sample(frac=0.08)
    ...
    #metrics_df.to_csv('../output_data3/DecisionTree.csv', index=False)
