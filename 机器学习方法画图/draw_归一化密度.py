...
def plot_average(fea_dict):
    ...
    plt.xlabel('SNR (dB)',fontsize=14,fontdict={'fontname':'Time News Roman'})
    plt.ylabel('归一化中心瞬时振幅功率密度峰值',fontsize=14,fontdict={'fontname':'SimSun'})
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('pictures\\归一化中心瞬时振幅功率密度峰值.svg')
    plt.show()
